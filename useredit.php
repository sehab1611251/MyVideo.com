...
if(isset($_POST['submit']))
{
 // $fullname= $_POST['fullname'];
  ...
  $update_info ="UPDATE `userinfo` SET `username`='$username',`email`='$email',`password`='$password',`phone`='$phone',`address`='$address' WHERE  id = '$user_id'";
    ...
    <form action="useredit.php" method="post">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <input type="text" class="form-control" id="phone" placeholder="Update phone" name="phone" value="<?php echo $phone ?>">
      </div>

       <div class="form-group">
        <label for="address">Address:</label>
        <input type="text" class="form-control" id="address" placeholder="Update Address" name="address" value="<?php echo $address ?>">
      </div>
