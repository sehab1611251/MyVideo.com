  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="image/h1.jpg" alt="Albert Einstein" style="width:1200px; height:400px">
      </div>

      <div class="item">
        <img src="image/h2.jpg" alt="ambrosebierce1" style="width:1200px; height:400px">
      </div>
    
      <div class="item">
        <img src="image/h3.jpg" alt="man_computer" style="width:1200px; height:400px">
      </div>
    </div>
...
<div id="about" class="container text-center"style="color: #000000; height: 400px; background-color: #C0C0C0;">
  <h1>myvideo.com</h1>
  <pre>myvideo.com is a learning website where viewers are mastering new skills and achieving heir goals.</pre> 
...
<form class="form-horizontal" action='feedback.php' method="POST">
  ...
  <div class="row">
    <div class="col-md-4" style="color: white;">
      ...
      <p><span class="glyphicon glyphicon-envelope"></span>Email: myvideo@gmail.com</p>
    </div>
    <div class="col-md-8">
      <div class="row">
        <div class="col-sm-6 form-group">
          <input class="form-control" id="id" name="id" placeholder="Enter Id" type="text" required>
        </div>
      </div>
