...
<div class="container" style="margin-top: 70px"> 
  <div class="panel panel-default">
    <div class="panel-body">
      <div class=" col-sm-10">
        <?php
        $show_details = "select * from userinfo where id='$id'";
        ...
        ?>
            ...
            <p><strong>Phone: </strong><?php echo $row_details['phone']?></p>
            <p><strong>Address: </strong><?php echo $row_details['address']?></p>
        <?php
          }
        }
        ?>
...
<div class="container">
  <div class="panel panel-default">
    ...
    <h3>Bookmark videos</h3>
      <div class="row">
        <?php
       // $show_bookmarks = "select * from bookmarks where bookmark_id='$bookmark_id'";
        $show_bookmarks = "select * from bookmarks where user_id='$id'";
