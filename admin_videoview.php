...
require 'connection.php';                                      //this portion is for delete video.
$msg="";
 ...
 <div class="container">                            
  <div class="panel panel-default">
    ...
    <tbody>
      ...
      <tr>
        <td><?php echo $i?></td>
        <td><a href="http://localhost/myvideo/video/<?php echo $row['video_path']?>"><?php echo $row['video_path']?></a></td>
        <td><?php echo $row['video_ext']?></td>
        <td><a href="http://localhost/myvideo/video/<?php echo $row['thumbnail_path']?>"><?php echo $row['thumbnail_path']?></a></td>
