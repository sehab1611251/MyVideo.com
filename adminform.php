...
$upload_video ="INSERT INTO `video`(`video_path`, `video_ext`, `thumbnail_path`, `category_id`, `caption`, `description`) VALUES ('$video_path','$videoFileType','$thumbnail_path','$category_id','$caption','$description')";
...
<html lang="en">
<head>
  <title>MyVideo | Upload Video</title>
  <meta charset="utf-8">
